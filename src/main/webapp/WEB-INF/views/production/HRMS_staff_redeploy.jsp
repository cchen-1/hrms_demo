          ...
          <!--在此写入-->
            <div class="page-title">
              <div class="title_left">
                <h3>职员管理 <small>Staff Management</small></h3>
              </div>
            </div>
            <div class="clearfix"></div>
            <hr/>
            ...
            <!--表格2可勾选表格-->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>职员调动管理 <small>StaffRedeployment Management</small></h3>
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal" onclick="transferEdit()">修改</button>
                    <button type="button" class="btn btn-danger" onclick="transferDelete()">删除</button>
                    <div class="clearfix"></div>
                  </div>
                      ...
                      <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">原部门</th>
                            <th class="column-title">原职位</th>
                            <th class="column-title">新部门</th>
                            <th class="column-title">新职位</th>
                        ...
                        <tbody>
                          <c:forEach var="record" items="${staffTransfers}">
	                          <tr class="even pointer">
	                            <td id="${record.staffTransferId}" class="a-center ">
	                              <input type="checkbox" class="flat" name="table_records">
	                            </td>
	                            <td class=" ">${record.staffNo}</td>
	                            <td class=" ">${record.staffName}</td>
	                            <td class=" ">${record.originalDepartment}</td>
	                            <td class=" ">${record.originalPost}</td>
	                            <td class=" ">${record.newDepartment}</td>
	                            <td class=" ">${record.newPost}</td>
	                          </tr>
                          </c:forEach>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">部门信息修改</h4>
                  </div>
                  <div class="modal-body">
                      <form  action="/hrms_demo/Department/updateDept" class="form-horizontal form-label-left input_mask" method="post">
                      <input style="display:none;" id="editDeptId" value="-1" name="deptId">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">部门编号<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" id="editDeptNo" name="deptNo" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">部门名称<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" id="editDeptName" name="deptName" required="required" type="text">
                        </div>
                      </div>
            ...
            <div class="modal fade bs-example-modal-md" tabindex="-1" role="dialog" aria-hidden="true">
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form action="/hrms_demo/staffTransfer/addStaffTransfer" class="form-horizontal form-label-left input_mask">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">员工工号<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="staffName" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">原部门<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="originalDepartment" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">原职位<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="originalPost" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">新部门<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="newDepartment" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">新职位<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="newPost" required="required" type="text">
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
