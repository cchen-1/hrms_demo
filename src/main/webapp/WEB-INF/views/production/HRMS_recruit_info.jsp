          ...
          <!--在此写入-->
            ...
            <!--表格2可勾选表格-->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>招聘信息管理 <small>Recruit Infomation</small></h3>
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal" onclick="recruitEdit()">修改</button>
                    <button type="button" class="btn btn-danger" onclick="recruitDelete()">删除</button>
                    <div class="clearfix"></div>
                    ...
                    <div  class="table-responsive">
                      <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <c:forEach var = "record"  items="${recruit}">
                            <tr class="even pointer">
                              <td id="${record.recruitId}" class="a-center ">
                                <input type="checkbox" class="flat" name="table_records">
                              </td>
                              <td class=" ">${record.title}</td>
                              <td class=" ">${record.recruitPost}</td>
                              <td class=" ">${record.recruitNumber}</td>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">招聘信息修改</h4>
                  </div>
                  <div class="modal-body">
                      <form  action="/hrms_demo/Recruit/updateRecruit" class="form-horizontal form-label-left input_mask" method="post">
                      <input style="display:none;" id="editRecruitId" value="-1" name="deptId">
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">标题<span class="required"></span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" id="editTitle" name="title" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" id="editPosName" name="recruitPost" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">招聘人数<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" id = "editNumber"name="recruitNumber" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <!--<input class="date-picker form-control col-md-7 col-xs-12" id="editStartTime" name="startTime" required="required" type="text">-->
                          <div class="form-group">
                              <div class='input-group date' id='myDatepicker'>
                                  <input type='text' id="editpublishDate" name="publishDate" class="form-control" />
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">结束时间</label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <div class='input-group date' id='myDatepicker1'>
                                  <input type='text' id="editEndDate" name="endDate" class="form-control" />
                                  <span class="input-group-addon">
                                     <span class="glyphicon glyphicon-calendar"></span>
                                  </span>
                              </div>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">招聘信息添加</h4>
                  </div>
                  <div class="modal-body">
                      <form  action="/hrms_demo/Recruit/addRecruit" class="form-horizontal form-label-left input_mask" method="post">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">标题<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="title" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name = "recruitNumber"required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <div class='input-group date' id='myDatepicker1b'>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">结束时间</label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <div class='input-group date' id='myDatepicker1a'>
...
<script>
    ...
    $('#myDatepicker1a').datetimepicker();
    $('#myDatepicker1b').datetimepicker();
