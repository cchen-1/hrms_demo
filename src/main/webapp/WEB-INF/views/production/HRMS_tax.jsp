            ...
            <div class="page-title">
              ...
              <div >
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <div class="progress"> 
                      <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: 3.75%;">
                        0~3000
                      </div> 
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                      <table class="table tile_info">
                        <thead>
                          <th>速算扣除数</th>
                        </thead>
                        <c:forEach var="record" items="${taxs}">
                          <tr> 
                            <td>
                              <p><i class="fa fa-square green"></i>${record.minimum} ~ ${record.maximum}</p>
                            </td>
                            <td><strong>${record.rate}</strong></td>
                            <td>${record.rapidCalculation}</td>
                          </tr>                          
                        </c:forEach>
                      </table>
                    </div>
