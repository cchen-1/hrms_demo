          ...
          <!--在此写入-->
            ...
            <!--表格2可勾选表格-->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>人才库管理 <small>Talent Pool Infomation</small></h3>
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal" onclick="talentEdit()">修改</button>
                    <button type="button" class="btn btn-danger" onclick="talentDelete()">删除</button>
                    <div class="clearfix"></div>
                    ...
                    <div  class="table-responsive">
                      <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <c:forEach var = "record"  items="${talentPools}">
                            <tr class="even pointer">
                              <td id="${record.talentPoolId}" class="a-center ">
                                <input type="checkbox" class="flat" name="table_records">
                              </td>
                              <td class=" ">${record.name}</td>
                              <td class=" ">${record.sex}</td>
                              <td class=" ">${record.email}</td>
                              <td class=" ">${record.recruitType}</td>
                              <td class=" ">${record.recruitPost}</td>
                              <td class=" ">${record.comment}</td>
                              <td class=" ">${record.resumeName}</td>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">人才库信息修改</h4>
                  </div>
                  <div class="modal-body">
                      <form  action="/hrms_demo/Department/updateDept" class="form-horizontal form-label-left input_mask" method="post">
                      <input style="display:none;" id="editTalentPoolId" value="-1" name="talentPoolId">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">姓名<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" id="editTalentName" name="talentName" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="email" id="editEmail" required="required"  type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="recruitType" id="editRecruitType" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="recruitPost" id="editRecruitPost" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">简历名称<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="resumeName" id="editResumeName" required="required" type="text">
                        </div>
                      </div>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">人才库信息录入</h4>
                  </div>
                  <div class="modal-body">
                      <form  action="/hrms_demo/talentPool/addTalentPool" class="form-horizontal form-label-left input_mask" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="email" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="recruitType" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="recruitPost" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="resumeName" required="required" type="text">
                        </div>
                      </div>
