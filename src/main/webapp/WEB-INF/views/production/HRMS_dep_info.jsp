          ...
          <!--在此写入-->
            ...
            <!--表格2可勾选表格-->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>部门信息管理 <small>Department Infomation</small></h3>
                    ...
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal" onclick="depEdit()">修改</button>
                    <button type="button" class="btn btn-danger" onclick="depDelete()">删除</button>
                    <div class="clearfix"></div>
                    ...
                    <div  class="table-responsive">
                      <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          ...
                          <c:forEach var = "info"  items="${departmentsInfo}">
                            <tr class="even pointer">
                              <td id="${info.departmentId}" class="a-center ">
                                <input type="checkbox" class="flat" name="table_records">
                              </td>
                              <td class=" ">${info.departmentNo}</td>
                              <td class=" ">${info.departmentName}</td>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="deptNo" required="required" type="text">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="deptName" required="required" type="text">
                        </div>
                      </div>
