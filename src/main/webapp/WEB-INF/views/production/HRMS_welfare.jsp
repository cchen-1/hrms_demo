          ...
          <!--在此写入-->
            ...
            <!--表格2可勾选表格-->
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h3>福利表管理 <small>Welfare Management</small></h3>
                    
                    <div id="welfare_donut" style="height:350px;"></div>

                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bs-example-modal-md">添加</button>
                    <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#editModal" onclick="welfareEdit()">修改</button>
                    <button type="button" class="btn btn-danger" onclick="welfareDelete()">删除</button>
                    <div class="clearfix"></div>
                  </div>
                      ...
                      <table id="datatable-checkbox" class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title">福利名称 </th>
                            <th class="column-title">总额 </th>
                            <th class="column-title">百分比 </th>
                        ...
                        <tbody>
                          <c:forEach var="record" items="${welfares}">
                            <tr class="even pointer">
                              <td id="${record.welfareId}" class="a-center ">
                                <input  type="checkbox" class="flat" name="table_records">
                              </td>
                              <td class=" ">${record.name}</td>
                              <td class=" ">${record.amount}</td>
                              <td class=" ">${record.percentage}</td>
                            </tr>                            
                          </c:forEach>
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      <form  action="/hrms_demo/welfare/updateWelfare" class="form-horizontal form-label-left input_mask" method="post">
                      <input style="display:none;" id="edit-welfareId" value="-1" name="welfareId">

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">福利名称<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="name" id="edit-name" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">总额<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="amount" required="required" id="edit-amount" type="text">
                        </div>
                      </div>


                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">百分比<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="percentage" id="edit-percentage" required="required" type="text">
                        </div>
                      </div>            
              ...
              <div class="modal-dialog modal-md">
                <div class="modal-content">
                  ...
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">福利信息录入</h4>
                  </div>
                  <div class="modal-body">
                      ...
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12">福利总额<span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="amount" required="required" type="text">
                        </div>
                      </div>

                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-6">福利百分比</label>
                        <div class="col-md-6 col-sm-6 col-xs-9">
                          <input class="date-picker form-control col-md-7 col-xs-12" name="percentage" required="required" type="text">
                        </div>
                      </div>
